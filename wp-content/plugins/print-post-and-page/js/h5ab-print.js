jQuery(document).ready(function($) {
    ...
    $('.h5ab-print-button').on('click',function(){
        ...
        iframeHead[0].innerHTML += '<style>html, body {width: 100%; height: 100%; margin: 0!important;font-family: arial!important;}html, body, div, span, applet, object, iframe,h1, h2, h3, h4, h5, h6, p, blockquote, pre,a, abbr, acronym, address, big, cite, code,del, dfn, em, img, ins, kbd, q, s, samp,small, strike, strong, sub, sup, tt, var,b, u, i, center,dl, dt, dd, ol, ul, li,fieldset, form, label, legend,table, caption, tbody, tfoot, thead, tr, th, td,article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary,time, mark, audio, video {font-family: arial!important;-webkit-box-sizing: border-box!important;-moz-box-sizing: border-box!important;box-sizing: border-box!important;font-family: arial!important;color: #111!important;}h1 a, h2 a, h3 a, h4 a, h5 a, h6 a {text-decoration: none!important; color: #000!important;}a, a:visited {color: #333!important;} img {max-width: 100%!important; height: auto!important;} article, aside, details, figcaption, figure, footer, header, hgroup, menu, nav, section {display: block!important;}table, th, tr, td {color: #111!important;}table {border: 1px solid #ddd!important;}.single-fathom .header, .archive.fathom .header, .archive.tag.fathom .header, .fathom .header{background-color: #325773 !important;border-bottom: 25px solid #6e889b;margin: 0 0 25px !important;width: 100%;height: 139px !important;}footer{margin-top: 25px !important;}</style>';
