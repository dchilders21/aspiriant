...
jQuery(document).ready(function($){
    ...
    sessionStorage.setItem('h5ab-print-article', '<header class="header"><img src="/wp/wp-content/uploads/fathom-logo-print.jpg" alt="Fathom"></header><div id="h5ab-print-content" style="margin-left:20px;"><h1><?php esc_attr(the_title()); ?></h1><p><?php
        $i = 1;
