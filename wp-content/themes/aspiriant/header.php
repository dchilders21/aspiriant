...
<!-- End Alexa Certify Javascript -->  
	...
	<body <?php body_class('mobile'); ?>><div id="container">
					...
					<nav role="navigation">
						<ul id="menu-main-nav" class="nav top-nav clearfix">
							...
							<div id="everything-else">
								...
								if (is_page(array('news-intel', 'library', 'intel', 'press', 'events', 'publications', 'white-papers', 'insight')) || get_post_type() == 'video') { echo 'active-trail '; } ?>menu-item menu-item-type-post_type menu-item-object-page menu-item-32"><a href="<?= $url; ?>news-intel/">News &amp; Blog</a> <span class="divider">|</span> 
									<?php
			...
			elseif ( is_page( array('los-angeles', 'san-francisco', 'new-york', 'boston', 'minneapolis', 'milwaukee', 'cincinnati-wealth-advisors', 'irvine', 'san-diego', 'silicon-valley', ) ) || 'bio' == get_post_type() ) 
			{
				wp_nav_menu( array( 'theme_location' => 'secondary-nav', 'menu_class'=> 'secondary-nav', 'link_after' => '<span class="divider">|</span>' ) );
